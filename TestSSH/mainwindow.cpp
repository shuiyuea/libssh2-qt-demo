...
//        password = argv[3];
//    }
    //hostaddr = inet_addr("192.168.110.66");
    //hostaddr = inet_addr("127.0.0.1");
    hostaddr = inet_addr(ui->ldtIP->text().toLocal8Bit().data());
    QByteArray byteName = ui->ldtName->text().toLatin1();
    QByteArray bytePassword = ui->ldtPassword->text().toLatin1();
    username = byteName.data();
    password = bytePassword.data();
